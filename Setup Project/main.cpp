...
int main(int argc, char **argv)
{
	...
	SDL_Rect runDestRect = { 0, 0, 128, 32 }; //x y, get image to bottom right of screen.w/h match clip/frame size
	...
	Animation anim2(runSpriteSheet, renderer, 4, 32, 32, 0.8); //800 milliseconds
	Animation anim3(runSpriteSheet, renderer, 4, 32, 32, 0.05); //50 milliseconds
